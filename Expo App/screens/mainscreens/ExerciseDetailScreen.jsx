  ...
  return (
    <SafeAreaView style={[styles.container, { paddingTop: insets.top, backgroundColor: theme.colors.background }]}>
      ...
      >
                ...
                >
                  ...
                  <View style={styles.videoOverlay}>
                    ...
                    <View style={styles.overlayCenterContent}>
                      <ThemedText style={[styles.exerciseTypeText, { color: theme.colors.textInverse }]} font="manrope" weight="bold">
                        {finalExerciseType}
                      </ThemedText>
        ...
        >
          <ThemedText style={[styles.exerciseTitleText, { color: theme.colors.text }]} font="manrope" weight="regular">
            {finalTitle}
          </ThemedText>
