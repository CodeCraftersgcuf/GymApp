...
@section('page-title', 'Edit Package: ' . $package->title)
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="bank_name" value="{{ old('bank_name', $package->bank_name) }}" required
                           class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
                ...
                <div>
                    ...
                    <input type="text" name="account_title" value="{{ old('account_title', $package->account_title) }}" required
                           class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
            ...
            <div>
                ...
                <input type="text" name="account_number" value="{{ old('account_number', $package->account_number) }}" required
                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
            ...
            <div>
                ...
                <input type="text" name="whatsapp_number" value="{{ old('whatsapp_number', $package->whatsapp_number) }}"
                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700"
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">{{ old('description', $package->description) }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="order" value="{{ old('order', $package->order) }}" min="0"
                           class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
